...
#ifdef _LEAKYBUCKET_
extern int get_LeakyBucketRate(InputParameters *p_Inp,
                               unsigned long NumberLeakyBuckets,
                               unsigned long *Rmin);
extern void PutBigDoubleWord(unsigned long dw, FILE *fp);
extern void write_buffer(InputParameters *p_Inp,
                         unsigned long NumberLeakyBuckets, unsigned long Rmin[],
                         unsigned long Bmin[], unsigned long Fmin[]);
