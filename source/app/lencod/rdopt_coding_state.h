...
extern CSobj *create_coding_state(
    InputParameters *p_Inp);  //!< create structure

extern void init_coding_state_methods(
    Slice *currSlice);  //!< Init methods given entropy coding
