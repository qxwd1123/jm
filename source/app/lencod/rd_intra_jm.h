...
extern int mode_decision_for_I4x4_blocks_JM_High(Macroblock *currMB, int b8,
                                                 int b4, int lambda,
                                                 distblk *min_cost);
extern int mode_decision_for_I4x4_blocks_JM_Low(Macroblock *currMB, int b8,
                                                int b4, int lambda,
                                                distblk *min_cost);
extern int find_best_mode_I16x16_MB(Macroblock *currMB, int lambda,
                                    distblk min_cost);
