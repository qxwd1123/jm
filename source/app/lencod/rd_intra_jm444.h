...
extern int mode_decision_for_I4x4_blocks_JM_High444(Macroblock *currMB, int b8,
                                                    int b4, int lambda,
                                                    distblk *min_cost);
extern int mode_decision_for_I4x4_blocks_JM_Low444(Macroblock *currMB, int b8,
                                                   int b4, int lambda,
                                                   distblk *min_cost);
#endif
