...
typedef struct pic_motion_params {
  ...
  byte field_frame;    //!< indicates if co_located is field or frame. Will be
...
typedef struct storable_picture {
  ...
  imgpel ****
      *imgUV_sub;  //!< UV picture component upsampled (Quarter/One-Eighth pel)
  ...
  imgpel ****p_img_sub[MAX_PLANE];  //!< pointer array for storing top address
                                    //!< of imgY_sub/imgUV_sub[]
  imgpel **p_curr_img;  //!< current int-pel ref. picture area to be used for
                        //!< motion estimation
  imgpel ****p_curr_img_sub;  //!< current sub-pel ref. picture area to be used
  ...
  PicMotionParams *
      *JVmv_info[MAX_PLANE];  //!< Motion info for 4:4:4 independent coding
  PicMotionParamsOld motion;  //!< Motion info
  PicMotionParamsOld
      JVmotion[MAX_PLANE];  //!< Motion info for 4:4:4 independent coding

  int colour_plane_id;  //!< colour_plane_id to be used for 4:4:4 independent
                        //!< mode encoding
...
typedef struct decoded_picture_buffer {
  ...
  void (*pf_GetHMEIntImagesLuma)(VideoParameters *p_Vid, int size_x, int size_y,
                                 imgpel ***cImgInt);

  void (*pf_luma_prediction)(Macroblock *currMB, int, int, int, int, int,
                             int[2], char *, short);
  void (*pf_luma_prediction_bi)(Macroblock *currMB, int, int, int, int, int,
                                int, short, short, int);
  void (*pf_chroma_prediction)(Macroblock *currMB, int, int, int, int, int, int,
                               int, int, short, short, short);
  void (*pf_get_block_luma)(struct video_par *, imgpel *, int *, int, int, int,
                            int, struct storable_picture *, int);
  void (*pf_get_block_chroma[2])(struct video_par *, imgpel *, int *, int, int,
                                 int, int, struct storable_picture *, int);
  void (*pf_OneComponentChromaPrediction4x4_regenerate)(Macroblock *currMB,
                                                        imgpel *, int, int,
                                                        MotionVector **,
                                                        StorablePicture *listX,
                                                        int);
  void (*pf_OneComponentChromaPrediction4x4_retrieve)(Macroblock *currMB,
                                                      imgpel *, int, int,
                                                      MotionVector **,
                                                      StorablePicture *listX,
                                                      int);
  distblk (*pf_computeSAD)(StorablePicture *ref1, MEBlock *, distblk,
                           MotionVector *);
  distblk (*pf_computeSADWP)(StorablePicture *ref1, MEBlock *, distblk,
                             MotionVector *);
  distblk (*pf_computeSATD)(StorablePicture *ref1, MEBlock *, distblk,
                            MotionVector *);
  distblk (*pf_computeSATDWP)(StorablePicture *ref1, MEBlock *, distblk,
                              MotionVector *);
  distblk (*pf_computeBiPredSAD1)(StorablePicture *ref1, StorablePicture *ref2,
                                  MEBlock *, distblk, MotionVector *,
                                  MotionVector *);
  distblk (*pf_computeBiPredSAD2)(StorablePicture *ref1, StorablePicture *ref2,
                                  MEBlock *, distblk, MotionVector *,
                                  MotionVector *);
  distblk (*pf_computeBiPredSATD1)(StorablePicture *ref1, StorablePicture *ref2,
                                   MEBlock *, distblk, MotionVector *,
                                   MotionVector *);
  distblk (*pf_computeBiPredSATD2)(StorablePicture *ref1, StorablePicture *ref2,
                                   MEBlock *, distblk, MotionVector *,
                                   MotionVector *);
  distblk (*pf_computeSSE)(StorablePicture *ref1, MEBlock *, distblk,
                           MotionVector *);
  distblk (*pf_computeSSEWP)(StorablePicture *ref1, MEBlock *, distblk,
                             MotionVector *);
  distblk (*pf_computeBiPredSSE1)(StorablePicture *ref1, StorablePicture *ref2,
                                  MEBlock *, distblk, MotionVector *,
                                  MotionVector *);
  distblk (*pf_computeBiPredSSE2)(StorablePicture *ref1, StorablePicture *ref2,
                                  MEBlock *, distblk, MotionVector *,
                                  MotionVector *);
...
extern void replace_top_pic_with_frame(DecodedPictureBuffer *p_Dpb,
                                       StorablePicture *p, FrameFormat *output);
...
extern void reorder_short_term(Slice *currSlice, DecodedPictureBuffer *p_Dpb,
...
extern void replace_top_proc_pic_with_frame(DecodedPictureBuffer *p_Dpb,
                                            StorablePicture *p);
extern void store_proc_picture_in_dpb(DecodedPictureBuffer *p_Dpb,
                                      StorablePicture *p, FrameFormat *output);
#endif
