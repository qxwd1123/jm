...
extern int FmoInit(VideoParameters *p_Vid, pic_parameter_set_rbsp_t *pps,
...
extern int FmoGetLastCodedMBOfSliceGroup(VideoParameters *p_Vid,
                                         int SliceGroupID);
extern int FmoStartPicture(VideoParameters *p_Vid);
extern int FmoEndPicture(void);
extern int FmoSliceGroupCompletelyCoded(VideoParameters *p_Vid,
                                        int SliceGroupID);
