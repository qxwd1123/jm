 ...
 ************************************************************************
 */
int quant_4x4_2step(Macroblock *currMB, int **tblock,
...
int quant_ac4x4_2step(Macroblock *currMB, int **tblock,
                      struct quant_methods *q_method) {
  int block_x = q_method->block_x;
 ...
 ************************************************************************
 */
int quant_dc4x4_2step(Macroblock *currMB, int **tblock, int qp, int *DCLevel,
