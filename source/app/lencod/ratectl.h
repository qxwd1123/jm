...
extern void rc_copy_generic(VideoParameters *p_Vid, RCGeneric *dst,
                            RCGeneric *src);
...
extern void rc_store_slice_header_bits(VideoParameters *p_Vid,
                                       InputParameters *p_Inp, int len);
