...
extern void writeRefPic_NRef_CAVLC(Macroblock *currMB, SyntaxElement *se,
                                   DataPartition *dp);
extern void writeRefPic_2Ref_CAVLC(Macroblock *currMB, SyntaxElement *se,
                                   DataPartition *dp);
extern void writeRefPic_Dummy(Macroblock *currMB, SyntaxElement *se,
                              DataPartition *dp);

extern void writeCBP_VLC(Macroblock *currMB, SyntaxElement *se,
                         DataPartition *dp);
extern void writeIntraPredMode_CAVLC(SyntaxElement *se, DataPartition *dp);
extern int writeSyntaxElement2Buf_UVLC(SyntaxElement *se,
                                       Bitstream *this_streamBuffer);
extern void writeUVLC2buffer(SyntaxElement *se, Bitstream *currStream);
extern void writeVlcByteAlign(VideoParameters *p_Vid, Bitstream *currStream,
                              StatParameters *cur_stats);
extern int writeSyntaxElement2Buf_Fixed(SyntaxElement *se,
                                        Bitstream *this_streamBuffer);
...
extern int writeSyntaxElement_VLC(SyntaxElement *se,
                                  DataPartition *this_dataPart);
extern int writeSyntaxElement_TotalZeros(SyntaxElement *se,
                                         DataPartition *this_dataPart);
extern int writeSyntaxElement_TotalZerosChromaDC(VideoParameters *p_Vid,
                                                 SyntaxElement *se,
                                                 DataPartition *this_dataPart);
extern int writeSyntaxElement_Run(SyntaxElement *se,
                                  DataPartition *this_dataPart);
extern int writeSyntaxElement_NumCoeffTrailingOnes(
    SyntaxElement *se, DataPartition *this_dataPart);
extern int writeSyntaxElement_NumCoeffTrailingOnesChromaDC(
    VideoParameters *p_Vid, SyntaxElement *se, DataPartition *this_dataPart);
extern int writeSyntaxElement_Level_VLC1(SyntaxElement *se,
                                         DataPartition *this_dataPart,
                                         int profile_idc);
extern int writeSyntaxElement_Level_VLCN(SyntaxElement *se, int vlc,
                                         DataPartition *this_dataPart,
                                         int profile_idc);

extern void writeUVLC_CAVLC(Macroblock *currMB, SyntaxElement *se,
                            DataPartition *dp);
extern void writeSVLC_CAVLC(Macroblock *currMB, SyntaxElement *se,
                            DataPartition *dp);
extern void writeFlag_CAVLC(Macroblock *currMB, SyntaxElement *se,
                            DataPartition *dp);
