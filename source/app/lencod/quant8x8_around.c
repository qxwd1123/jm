 ...
 ************************************************************************
 */
int quant_8x8_around(Macroblock *currMB, int **tblock,
 ...
 ************************************************************************
 */
int quant_8x8cavlc_around(Macroblock *currMB, int **tblock,
    ...
    for (coeff_ctr = 0; coeff_ctr < 16; ++coeff_ctr) {
      ...
      if (*m7 != 0) {
        ...
        if (level != 0) {
          ...
          *padjust8x8 = rshift_rnd_sf(
              (AdaptRndWeight * (scaled_coeff - (level << q_bits))),
              (q_bits + 1));
