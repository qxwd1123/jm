...
************************************************************************
*/
distblk computeSAD(StorablePicture *ref1, MEBlock *mv_block, distblk min_mcost,
                   MotionVector *cand) {
  int mcost = 0;
...
************************************************************************
*/
distblk computeSADWP(StorablePicture *ref1, MEBlock *mv_block,
...
************************************************************************
*/
distblk computeBiPredSAD1(StorablePicture *ref1, StorablePicture *ref2,
...
************************************************************************
*/
distblk computeBiPredSAD2(StorablePicture *ref1, StorablePicture *ref2,
                          MEBlock *mv_block, distblk min_mcost,
                          MotionVector *cand1, MotionVector *cand2) {
  int imin_cost = dist_down(min_mcost);
  int mcost = 0;
...
************************************************************************
*/
distblk computeSATD(StorablePicture *ref1, MEBlock *mv_block, distblk min_mcost,
                    MotionVector *cand) {
  int imin_cost = dist_down(min_mcost);
  int mcost = 0;
  int y, x, y4;
...
************************************************************************
*/
distblk computeSATDWP(StorablePicture *ref1, MEBlock *mv_block,
                      distblk min_mcost, MotionVector *cand) {
  int imin_cost = dist_down(min_mcost);
  int mcost = 0;
  int y, x, y4;
...
************************************************************************
*/
distblk computeBiPredSATD1(StorablePicture *ref1, StorablePicture *ref2,
                           MEBlock *mv_block, distblk min_mcost,
                           MotionVector *cand1, MotionVector *cand2) {
  int imin_cost = dist_down(min_mcost);
  int mcost = 0;
...
************************************************************************
*/
distblk computeBiPredSATD2(StorablePicture *ref1, StorablePicture *ref2,
                           MEBlock *mv_block, distblk min_mcost,
                           MotionVector *cand1, MotionVector *cand2) {
  int imin_cost = dist_down(min_mcost);
  int mcost = 0;
...
************************************************************************
*/
distblk computeSSE(StorablePicture *ref1, MEBlock *mv_block, distblk min_mcost,
                   MotionVector *cand) {
  int imin_cost = dist_down(min_mcost);
  int mcost = 0;
  int y, x;
...
************************************************************************
*/
distblk computeSSEWP(StorablePicture *ref1, MEBlock *mv_block,
                     distblk min_mcost, MotionVector *cand) {
  int imin_cost = dist_down(min_mcost);
  int mcost = 0;
  int y, x;
...
************************************************************************
*/
distblk computeBiPredSSE1(StorablePicture *ref1, StorablePicture *ref2,
                          MEBlock *mv_block, distblk min_mcost,
                          MotionVector *cand1, MotionVector *cand2) {
  int imin_cost = dist_down(min_mcost);
  int mcost = 0;
...
************************************************************************
*/
distblk computeBiPredSSE2(StorablePicture *ref1, StorablePicture *ref2,
                          MEBlock *mv_block, distblk min_mcost,
                          MotionVector *cand1, MotionVector *cand2) {
  int imin_cost = dist_down(min_mcost);
  int mcost = 0;
...
void calcDifference(imgpel **origImg, int ox, int oy, imgpel **predImg, int px,
                    int py, int width, int height, short *diff) {
  int i, j;
  imgpel *orig, *pred;
  for (j = 0; j < height; j++) {
