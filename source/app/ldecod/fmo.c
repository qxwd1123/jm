...
static int FmoGenerateMapUnitToSliceGroupMap(VideoParameters *p_Vid,
  ...
  switch (pps->slice_group_map_type) {
    case 0: FmoGenerateType0MapUnitMap(p_Vid, NumSliceGroupMapUnits); break;
    case 1: FmoGenerateType1MapUnitMap(p_Vid, NumSliceGroupMapUnits); break;
    case 2: FmoGenerateType2MapUnitMap(p_Vid, NumSliceGroupMapUnits); break;
    case 3:
    ...
    case 5:
      ...
      break;
    case 6: FmoGenerateType6MapUnitMap(p_Vid, NumSliceGroupMapUnits); break;
    default:
...
int FmoGetLastMBInSliceGroup(VideoParameters *p_Vid, int SliceGroup) {
  ...
  for (i = p_Vid->PicSizeInMbs - 1; i >= 0; i--)
    if (FmoGetSliceGroupId(p_Vid, i) == SliceGroup) return i;
  return -1;
}
...
static void FmoGenerateType3MapUnitMap(VideoParameters *p_Vid,
  ...
  for (i = 0; i < PicSizeInMapUnits; i++) p_Vid->MapUnitToSliceGroupMap[i] = 2;
