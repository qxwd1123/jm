...
// static void get_strength_ver_MBAff     (Macroblock *MbQ, int edge, int
// mvlimit, StorablePicture *p); static void get_strength_hor_MBAff (Macroblock
// *MbQ, int edge, int mvlimit, StorablePicture *p);
static void edge_loop_luma_ver_MBAff(ColorPlane pl, imgpel **Img,
                                     byte *Strength, Macroblock *MbQ, int edge);
static void edge_loop_luma_hor_MBAff(ColorPlane pl, imgpel **Img,
                                     byte *Strength, Macroblock *MbQ, int edge,
                                     StorablePicture *p);
static void edge_loop_chroma_ver_MBAff(imgpel **Img, byte *Strength,
                                       Macroblock *MbQ, int edge, int uv,
                                       StorablePicture *p);
static void edge_loop_chroma_hor_MBAff(imgpel **Img, byte *Strength,
                                       Macroblock *MbQ, int edge, int uv,
                                       StorablePicture *p);
 ...
 *********************************************************************************************
 */
void get_strength_ver_MBAff(byte *Strength, Macroblock *MbQ, int edge,
 ...
 *********************************************************************************************
 */
void get_strength_hor_MBAff(byte *Strength, Macroblock *MbQ, int edge,
                            int mvlimit, StorablePicture *p) {
  short blkP, blkQ, idx;
  short blk_x, blk_x2, blk_y, blk_y2;
 ...
 *****************************************************************************************
 */
void get_db_strength_mbaff(VideoParameters *p_Vid, StorablePicture *p,
                           int MbQAddr) {
  ...
  if (MbQ->DFDisableIdc == 1) {
    ...
    for (edge = 0; edge < 4; ++edge) {
      ...
      if (edge || filterLeftMbEdgeFlag) {
        ...
        if ((*((int64 *)Strength)) ||
            ((*(((int64 *)Strength) +
                1))))  // only if one of the 16 Strength bytes is != 0
        {
    ...
    for (edge = 0; edge < 4; ++edge) {
      ...
      if (edge || filterTopMbEdgeFlag) {
            ...
            MbQ->mixedModeEdgeFlag)  // currSlice->mixedModeEdgeFlag)
        {
          ...
          MbQ->DeblockCall = 2;
          p_Vid->GetStrengthHor(MbQ, 4, mvlimit,
