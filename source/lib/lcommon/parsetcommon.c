...
int sps_is_equal(seq_parameter_set_rbsp_t *sps1,
  ...
  if ((!sps1->Valid) || (!sps2->Valid)) return 0;
...
int pps_is_equal(pic_parameter_set_rbsp_t *pps1,
  ...
  if ((!pps1->Valid) || (!pps2->Valid)) return 0;
  ...
  equal &= (pps1->num_ref_idx_l0_default_active_minus1 ==
            pps2->num_ref_idx_l0_default_active_minus1);
  equal &= (pps1->num_ref_idx_l1_default_active_minus1 ==
            pps2->num_ref_idx_l1_default_active_minus1);
