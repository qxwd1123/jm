...
// In the MPEG-4 AVC/H.264 syntax, frequently flags are used that indicate the
// presence of certain pieces of information in the NALU.  Here, these flags are
// also present.  In the encoder, those bits indicate that the values signaled
// to be present are meaningful and that this part of the syntax should be
