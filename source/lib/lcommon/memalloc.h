...
extern int get_mem2Dint_pad(int ***array2D, int dim0, int dim1, int iPadY,
                            int iPadX);
...
extern int get_mem4Dint(int *****array4D, int dim0, int dim1, int dim2,
                        int dim3);
extern int get_mem4Dint64(int64 *****array4D, int dim0, int dim1, int dim2,
                          int dim3);
extern int get_mem5Dint(int ******array5D, int dim0, int dim1, int dim2,
                        int dim3, int dim4);
...
extern int get_mem4Ddistblk(distblk *****array4D, int dim0, int dim1, int dim2,
                            int dim3);
...
extern int get_mem2Dpel_pad(imgpel ***array2D, int dim0, int dim1, int iPadY,
                            int iPadX);

extern int get_mem3Dpel(imgpel ****array3D, int dim0, int dim1, int dim2);
extern int get_mem3Dpel_pad(imgpel ****array3D, int dim0, int dim1, int dim2,
                            int iPadY, int iPadX);
extern int get_mem4Dpel(imgpel *****array4D, int dim0, int dim1, int dim2,
                        int dim3);
extern int get_mem4Dpel_pad(imgpel *****array4D, int dim0, int dim1, int dim2,
                            int dim3, int iPadY, int iPadX);
extern int get_mem5Dpel(imgpel ******array5D, int dim0, int dim1, int dim2,
                        int dim3, int dim4);
extern int get_mem5Dpel_pad(imgpel ******array5D, int dim0, int dim1, int dim2,
...
extern int get_mem3Dodouble(double ****array2D, int dim0, int dim1, int dim2,
                            int offset);

extern int get_mem2Doint(int ***array2D, int dim0, int dim1, int offset);
extern int get_mem3Doint(int ****array3D, int dim0, int dim1, int dim2,
                         int offset);
...
extern void free_mem3Dpel_pad(imgpel ***array3D, int iDim12, int iPadY,
                              int iPadX);
extern void free_mem4Dpel(imgpel ****array4D);
extern void free_mem4Dpel_pad(imgpel ****array4D, int iFrames, int iPadY,
                              int iPadX);
extern void free_mem5Dpel(imgpel *****array5D);
extern void free_mem5Dpel_pad(imgpel *****array5D, int iFrames, int iPadY,
                              int iPadX);
...
extern void copy2DImage(imgpel **dst_img, imgpel **src_img, int size_x,
                        int size_y);
extern void no_mem_exit(char *where);
extern int malloc_mem2Dpel_2SLayers(imgpel ***buf0, int imgtype0,
                                    imgpel ***buf1, int imgtype1, int height,
                                    int width);
extern int malloc_mem3Dpel_2SLayers(imgpel ****buf0, int imgtype0,
                                    imgpel ****buf1, int imgtype1, int frames,
...
static inline void mem_free(void *a) { free_pointer(a); }
